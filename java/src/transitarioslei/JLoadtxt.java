 ...
 * @author André
 */
public class JLoadtxt extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JLoadtxt
     */
    public JLoadtxt(JMain root, SClientes sclientes, SLocalidade slocalidades) {
        this.root = root;
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Carregar Localidades e Clientes");
        setAlwaysOnTop(true);
        setResizable(false);
        ...
        jLabel1.setText("Ficheiro Clientes:");

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText("Ficheiro Localidades:");
        ...
        jButton5.setText("Carregar Localidades");
        ...
        jButton2.setText("Carregar Localidades e Clientes");
        ...
        jLabel3.setText("Ficheiro Ligacões:");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            clientes.lerClientes(jTextField1.getText(), 10000000);
            root.update();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (f.exists() == false) {
            JOptionPane.showMessageDialog(this, "O ficheiro de localidades especificado não foi encontrado.", "Informação", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        if (f2.exists() == false){
            JOptionPane.showMessageDialog(this, "O ficheiro de ligações especificado não foi encontrado.", "Informação", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        try {
            localidades.lerLocalidades(jTextField2.getText(),jTextField3.getText(), 10000000);
            root.update();
