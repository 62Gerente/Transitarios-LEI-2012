...
public class JLoad extends javax.swing.JFrame {
     ...
     */
    public JLoad(JMain root, SClientes sclientes, SLocalidade slocalidades) {
        this.root = root;
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            localidades.lerobjLocalidades(jTextField2.getText());
            clientes.lerobjClientes(jTextField1.getText());
            this.dispose();
            root.update();
